#Blue BrightestFinal copy game By Mouctar Diallo
...
def option_principalhelp():
  ...
  print ("""A. Suspend the bullies for three days
    B. Organize a presentation for the whole school (including the bullies) speaking about respecting 
  ...
  if choice in answer_A:
    ...
    print("you got rid of the bullies but they didn't learn anything"
